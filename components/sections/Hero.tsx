...
function ChatMockup() {
  return (
    <div className="relative w-full max-w-[272px] mx-auto">
      {/* Phone frame */}
      <div
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center">
            <span className="text-[9px] bg-white/80 text-gray-500 px-2.5 py-0.5 rounded-full font-medium border border-gray-100">
              Hoy
            </span>
          </div>
          ...
          <div className="self-end max-w-[78%]">
            <div className="bg-brand-700 rounded-2xl rounded-tr-sm px-3 py-2 shadow-sm">
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-white">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(ellipse 70% 55% at 5% 45%, rgba(187,247,208,0.18) 0%, transparent 65%)`,
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          {/* Eyebrow */}
          <p className="text-sm text-brand-700 font-medium mb-7 animate-fade-up">
            1 mes gratis · Sin tarjeta de crédito
          </p>

          {/* Headline */}
          <h1
            className="text-5xl lg:text-6xl xl:text-[4.25rem] font-light text-ink leading-[1.05] tracking-tight mb-6 animate-fade-up animate-delay-100"
            style={{ fontFamily: "var(--font-fraunces)" }}
          >
            El contrato de tu{" "}
            <em className="not-italic text-brand-700">trabajadora</em>
            <br />
            por WhatsApp.
          </h1>

          {/* Subtitle */}
          <p className="text-lg text-ink-muted leading-relaxed max-w-lg mb-10 animate-fade-up animate-delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 animate-fade-up animate-delay-300">
            <CtaButton className="inline-flex items-center justify-center gap-2.5 bg-brand-700 hover:bg-brand-800 active:bg-brand-900 text-white font-medium px-6 py-3.5 rounded-lg transition-colors">
            ...
            <a
              href="#como-funciona"
              className="inline-flex items-center justify-center gap-2 text-ink-muted hover:text-ink font-medium px-6 py-3.5 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors bg-white"
            >
              Ver cómo funciona
          ...
          {/* Reassurance */}
          <p className="mt-10 text-sm text-ink-light animate-fade-up animate-delay-400">
            Construido por un abogado, para empleadores en Chile.
          </p>
        </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce opacity-20">
