const trustItems = [
  {
    ...
    body: "GoLegit fue diseñado por un abogado especializado en derecho laboral chileno. Las plantillas cumplen con el Art. 10 del Código del Trabajo y la Ley 20.786. No son formularios genéricos de internet.",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          {trustItems.map((item, i) => (
            <div key={i} className="flex gap-4 p-6 rounded-2xl border border-gray-100 hover:border-gray-200 transition-colors group">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-5 p-6 rounded-2xl border border-gray-200">
          ...
          <div>
            <p className="font-bold text-ink mb-1">Alerta automática: registro en la Inspección del Trabajo</p>
