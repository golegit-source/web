    ...
    <section className="py-24 bg-[#111827] text-white overflow-hidden relative">
      <div className="relative max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left */}
          <div>
            <p className="text-sm text-white/40 mb-4">La solución</p>
            <h2
              className="text-4xl lg:text-5xl font-light mt-2 mb-6 leading-tight"
            ...
            <div className="flex flex-col gap-4 mb-10">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-md bg-white/10 border border-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <CtaButton className="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-500 text-white font-medium px-6 py-3 rounded-lg transition-colors">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                key={i}
                className="p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/8 transition-colors"
              >
                <p
